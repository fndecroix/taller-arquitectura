...
class HttpInterfaceTest(TestCase):
    ...
    def test_article_list_when_there_are_no_articles_is_empty(self):
        self.assertEquals(len(self.interface.get(self._http_request_with_path('/articles')).content()), 0)
    ...
    def test_can_get_article_list_with_a_single_article(self):
        ...
        article_list = self.interface.get(self._http_request_with_path('/articles')).content()
    ...
    def test_can_get_details_from_a_single_article(self):
        ...
        article_details = self.interface.get(self._http_request_with_path(path)).content()
