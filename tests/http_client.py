...
class HttpClient:
    ...
    def get_articles(self):
        return self._interface.get_articles(self._http_request_with(parameters={}))

    def get_article(self, article_number):
        parameters = {'article_number': article_number}
        return self._interface.get_article(self._http_request_with(parameters=parameters))
